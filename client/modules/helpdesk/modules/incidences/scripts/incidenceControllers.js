...
incidencesControllers.controller('CloseModalInstanceCtrl', function ($scope, $modalInstance, incidence) {
...
incidencesControllers.controller('AssignModalInstanceCtrl', function ($scope, $modalInstance, incidence, accountResourceService) {
...
incidencesControllers.controller('AssignCtrl', function ($scope, $modal, $log) {
